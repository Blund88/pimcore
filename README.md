...
* You must have node / npm installed locally to compile the frontend assets
...
5. Install npm packages / run build for compiling frontend assets
   * Run `npm install` and then `npm run dev` or `npm run build` to compile the frontend assets
